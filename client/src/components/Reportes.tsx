...
const COLORES = ['#2c2560', '#d4a24c', '#1e8e5a', '#dc3545', '#3a2f7a', '#b8790a', '#0d9488', '#7c3aed'];
...
function Reportes() {
  ...
  return (
    <div>
      <h2 style={{ color: '#2c2560', marginBottom: '1.5rem' }}>Reportes</h2>

      <div style={cardStyle}>
        <h3 style={{ color: '#2c2560', fontSize: '1rem', marginBottom: '1rem' }}>Equipos por oficina</h3>
        <ResponsiveContainer width="100%" height={280}>
          <BarChart data={datosOficina}>
            ...
            <Tooltip />
            <Bar dataKey="cantidad" fill="#2c2560" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
        <div style={cardStyle}>
          <h3 style={{ color: '#2c2560', fontSize: '1rem', marginBottom: '1rem' }}>Equipos por estado</h3>
        ...
        <div style={cardStyle}>
          <h3 style={{ color: '#2c2560', fontSize: '1rem', marginBottom: '1rem' }}>Con / sin responsable</h3>
          <ResponsiveContainer width="100%" height={260}>
            <PieChart>
      ...
      <div style={cardStyle}>
        <h3 style={{ color: '#2c2560', fontSize: '1rem', marginBottom: '1rem' }}>Top 10 tipos de equipo</h3>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={datosTipo} layout="vertical" margin={{ left: 60 }}>
            ...
            <Tooltip />
            <Bar dataKey="cantidad" fill="#d4a24c" radius={[0, 4, 4, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
